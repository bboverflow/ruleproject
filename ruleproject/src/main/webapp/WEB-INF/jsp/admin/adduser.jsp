...
<form id="userform" action="${baseurl}admin/addusersubmit.action" method="post">
                ...
                <TABLE class="toptable grid" border=1 cellSpacing=1 cellPadding=4
                    ...
                    <TR>
                        ...
                        <TD class=category width="35%">
                            <div>
                                <input type="text" id="user_id" name="userCustom.id"/>
                            </div>
                        ...
                        <TD class=category width="35%">
                            <div>
                                <input type="text" id="user_username" name="userCustom.username"/>
                            </div>
                    ...
                    <TR>
                        ...
                        <TD class=category width="35%">
                            <div>
                                <input type="password" id="user_password" name="userCustom.password"/>
                            </div>
...
--%>
                    ...
                    <TR>
                        ...
                        <TD class=category width="35%">
                            ...
                            <input type="radio" name="userCustom.locked" value="0"/>未锁定
                        </TD>
